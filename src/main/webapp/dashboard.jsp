...
<body>
    ...
    <script>
        ...
        function logout() {
            ...
            // For now, simply redirect to the homepage.html file
    ...
    <script>
        ...
        // Set the logged-in user's email directly in JavaScript
        const loggedInUserEmail = "example@example.com"; // Replace this with the actual email
